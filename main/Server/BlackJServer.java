...
public class BlackJServer {

    ArrayList<BlackJSession> sessions;
    GameServer<ClientPacket, ServerPacket> gamesServer;

    Map<Integer, String> names;

    BlackJServer(int Port) {

        gamesServer = new GameServer<ClientPacket, ServerPacket>(Port, (String s) -> ClientPacket.convertFromString(s),
